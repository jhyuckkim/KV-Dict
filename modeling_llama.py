...
from kvarena.methods.KVDict.generation_utils import GenerationConfig, GenerationMixinKVDict
...
class LlamaForCausalLMKVDict(LlamaPreTrainedModel, GenerationMixinKVDict):
    _tied_weights_keys = ["lm_head.weight"]

    def __init__(self, config): ## HERE False
        super().__init__(config)
